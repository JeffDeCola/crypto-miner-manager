...
echo "cp -r crypto-miner-manager/crypto-miner-manager-code/* dist"
cp -r crypto-miner-manager/crypto-miner-manager-code/* dist
echo " "
...
#echo "cd src/github.com/JeffDeCola/crypto-miner-manager/crypto-miner-manager-code"
#cd src/github.com/JeffDeCola/crypto-miner-manager/crypto-miner-manager-code
#echo " "
...
#cp "$GOPATH/src/github.com/JeffDeCola/crypto-miner-manager/crypto-miner-manager-code/bin/hello-go" .
#echo " "

#echo "cp the Dockerfile into /dist"
#cp "$GOPATH/src/github.com/JeffDeCola/crypto-miner-manager/crypto-miner-manager-code/build-push/Dockerfile" .
#echo " "
